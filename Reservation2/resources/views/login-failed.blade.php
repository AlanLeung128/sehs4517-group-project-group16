...
<body class="bg-brand-bg text-brand-text font-['Helvetica_Neue'] leading-relaxed">
    ...
    <main class="max-w-md mx-auto my-10 px-5">
        <div class="bg-white p-8 rounded-lg shadow-md text-center">
            <div class="text-6xl mb-4 shake">🎲</div>
            ...
            <div class="flex gap-4">
                <a href="{{ route('login') }}" class="flex-1 bg-brand-subtitle text-white py-3 rounded-md font-bold transition-colors duration-300 hover:bg-brand-title text-center">
                    Try Again
                </a>
                <a href="{{ route('introduction') }}" class="flex-1 bg-gray-400 text-white py-3 rounded-md font-bold transition-colors duration-300 hover:bg-gray-500 text-center">
