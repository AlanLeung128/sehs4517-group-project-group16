...
<body class="bg-brand-bg text-brand-text font-sans leading-relaxed">
    ...
    <main class="max-w-3xl mx-auto my-12 px-6">
        <div class="bg-white p-10 rounded-3xl shadow-md text-center border border-[#d4b89e]">
            ...
            <p class="text-xl mb-10">Your reservation has been successfully made.<br>
               We look forward to seeing you at Cerebral Corner!</p>
            ...
            <div class="bg-brand-bg/60 rounded-2xl p-8 text-left border border-brand-subtitle/30">
                ...
                <div class="space-y-4 text-lg">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold">{{ $reservation->space_name }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-medium">Time Slot:</span>
                        <span class="font-bold">{{ $reservation->time_slot }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="font-medium">Board Game:</span>
                        <span class="font-bold">{{ $reservation->game ?? 'Not selected' }}</span>
                    </div>
                </div>
            </div>
            @else
                <p class="text-amber-700">Reservation details not available.</p>
            @endif
        ...
        <div class="text-center mt-10">
            <a href="{{ route('reservation.index') }}" 
               class="inline-block bg-brand-subtitle hover:bg-brand-title text-white py-4 px-10 rounded-3xl text-xl font-bold transition-all">
