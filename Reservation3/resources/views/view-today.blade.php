<DOCUMENT filename="view-today.blade.php">
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-brand-bg text-brand-text font-sans">
    ...
    <div class="max-w-6xl mx-auto p-8">
        ...
        <div class="mb-12">
            <h2 class="text-3xl font-bold mb-6 flex items-center gap-3 text-brand-title">
                <i class="fas fa-user-clock"></i> My Bookings
            </h2>
    ...
    <script>
        ...
        const myBookings = @json($myBookings ?? []);   // 後端需傳入個人預約資料
            ...
            myBookings.forEach(booking => {
                ...
                <div class="border border-[#d4b89e] rounded-2xl p-6 bg-white">
                    <div class="flex justify-between items-start">
                        <div>
                            <div class="font-bold text-xl">${booking.space}</div>
                            <div class="text-sm text-gray-500 mt-1">${booking.date} • ${booking.time_slot}</div>
                        </div>
