...
<body class="bg-brand-bg text-brand-text font-sans">
    ...
    <div class="max-w-6xl mx-auto p-8">
        ...
        <div class="flex justify-between items-center mb-10">
            <h1 class="text-4xl font-bold text-brand-title">Today's Reservations</h1>
        ...
        <div class="flex gap-6 mb-8 text-sm">
            <div class="flex items-center gap-2">
                <div class="w-5 h-5 bg-red-200 rounded"></div> Past Time Slot
            </div>
            <div class="flex items-center gap-2">
                <div class="w-5 h-5 bg-gray-200 rounded"></div> Already Booked
            </div>
            <div class="flex items-center gap-2">
                <div class="w-5 h-5 bg-green-100 rounded"></div> Available
            </div>
        </div>
