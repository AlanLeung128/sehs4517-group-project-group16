        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form method="post" action="login-process.php">
                <div class="mb-4">
                    ...
                    <input type="email" name="email" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:border-brand-subtitle">
                </div>
                
                <div class="mb-6">
                    <label class="block text-brand-text font-bold mb-2">Password</label>
                    <input type="password" name="password" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:border-brand-subtitle">
                </div>
